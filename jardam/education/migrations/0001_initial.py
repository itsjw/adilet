# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-21 13:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='article', to='education.Education', verbose_name='Статья')),
            ],
        ),
    ]
